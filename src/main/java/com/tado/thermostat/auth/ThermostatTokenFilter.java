...
public class ThermostatTokenFilter extends RequestHeaderAuthenticationFilter {

	private static final String HEADER_KEY = "Authorization";
	
	public ThermostatTokenFilter(final AuthenticationManager authenticationManager) {
